import { FindAllBatchPromotionController } from './use-cases/find-all-batch-promotions-filtered/find-all-batch-promotion.controller';
...
import { FindAllBatchPromotionUseCase } from './use-cases/find-all-batch-promotions-filtered/find-all-batch-promotion.use-case';
...
import { BatchPromotionRepository } from './models/repository/lote-promocao.repository';
import { DB_PG_DATABASE } from 'src/shared/database/typeOrm/postgres.config';
import { TypeOrmModule } from '@nestjs/typeorm';
import { PromocaoLote } from './models/entity/batchPromotion.entity';
